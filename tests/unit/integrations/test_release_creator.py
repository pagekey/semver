...
from pagekey_semver.integrations.release_creator import CreateReleaseConfig, GitHubReleaseCreator, GitLabReleaseCreator
    ...
    class Test_create_release:
        ...
        def test_with_successful_request_makes_request(self, mock_requests, mock_os):
            ...
            mock_requests.post.assert_called_with(
                ...
                headers={
                    "Authorization": f"token my-github-token",
    ...
    class Test_create_release:
        ...
        def test_with_successful_request_makes_request(self, mock_requests, mock_os):
            ...
            mock_requests.post.assert_called_with(
                ...
                headers={
                    "PRIVATE-TOKEN": f"my-gitlab-token",
